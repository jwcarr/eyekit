...
"url":2,
"doc":"Tag this fixation with some arbitrary tag.",
"func":1
},
{
...
"url":2,
"doc":"Discard all fixations that are shorter than some threshold value. Note that this only flags fixations as discarded and doesn't actually remove them; to remove discarded fixations, call  eyekit.fixation.FixationSequence.purge() after discarding.",
"func":1
},
{
...
"url":2,
"doc":"Given a  eyekit.text.TextBlock , snap each fixation to the line that it most likely belongs to, eliminating any y-axis variation. Several methods are available (see below), some of which take optional parameters or require NumPy/SciPy to be installed. See [Carr et al. (2021)](https: doi.org/10.3758/s13428-021-01554-0) for a full description and evaluation of these methods. Note that in single-line TextBlocks, the  method parameter has no effect: all fixations will be snapped to the one line. If a list of methods is passed in, each fixation will be snapped to the line with the most \"votes\" across the selection of methods(in the case of a tie, the left-most method takes priority). This \"wisdom of the crowd\" approach usually results in better performance; ideally, you should choose a selection of at least three methods that have different general properties: for example,  ['chain', 'cluster', 'warp'] . When wisdom of the crowd is used, Fleiss's kappa is returned, indicating how much agreement there is among the methods; if this value is low (e.g. < 0.7), you may want to investigate the trial further. -  chain : Chain consecutive fixations that are sufficiently close to each other, and then assign chains to their closest text lines. Default params:  x_thresh=192 ,  y_thresh=32 . Requires NumPy. -  cluster : Classify fixations into  m clusters based on their Y-values, and then assign clusters to text lines in positional order. Requires SciPy. -  merge : Form a set of progressive sequences and then reduce the set to  m by repeatedly merging those that appear to be on the same line. Merged sequences are then assigned to text lines in positional order. Default params:  y_thresh=32 ,  gradient_thresh=0.1 ,  error_thresh=20 . Requires NumPy. -  regress : Find  m regression lines that best fit the fixations and group fixations according to best fit regression lines, and then assign groups to text lines in positional order. Default params:  slope_bounds=(-0.1, 0.1) ,  offset_bounds=(-50, 50) ,  std_bounds=(1, 20) . Requires SciPy. -  segment : Segment fixation sequence into  m subsequences based on  m \u20131 most-likely return sweeps, and then assign subsequences to text lines in chronological order. Requires NumPy. -  split : Split fixation sequence into subsequences based on best candidate return sweeps, and then assign subsequences to closest text lines. Requires SciPy. -  stretch : Find a stretch factor and offset that results in a good alignment between the fixations and lines of text, and then assign the transformed fixations to the closest text lines. Default params:  stretch_bounds=(0.9, 1.1) ,  offset_bounds=(-50, 50) . Requires SciPy. -  warp : Map fixations to word centers using [Dynamic Time Warping](https: en.wikipedia.org/wiki/Dynamic_time_warping). This finds a monotonically increasing mapping between fixations and words with the shortest overall distance, effectively resulting in  m subsequences. Fixations are then assigned to the lines that their mapped words belong to, effectively assigning subsequences to text lines in chronological order. Requires NumPy.",
"func":1
},
{
...
"url":3,
"doc":"Deprecated in 0.4. Use  eyekit.fixation.FixationSequence.discard_short_fixations() .",
"func":1
},
{
"ref":"eyekit.tools.discard_out_of_bounds_fixations",
"url":3,
"doc":"Deprecated in 0.4. Use  eyekit.fixation.FixationSequence.discard_out_of_bounds_fixations() .",
"func":1
},
{
"ref":"eyekit.tools.snap_to_lines",
"url":3,
"doc":"Deprecated in 0.4. Use  eyekit.fixation.FixationSequence.snap_to_lines() .",
"func":1
},
{
"ref":"eyekit.io",
...
"ref":"eyekit.io.read",
"url":4,
"doc":"Deprecated in 0.4. Use  eyekit.io.load() .",
"func":1
},
{
"ref":"eyekit.io.write",
"url":4,
"doc":"Deprecated in 0.4. Use  eyekit.io.save() .",
"func":1
},
{
"ref":"eyekit.vis",
...
"url":6,
"doc":"Return the word that the fixation falls inside as an  InterestArea . For the interpretation of  pattern ,  line_n , and  alphabetical_only , see  TextBlock.words() .",
"func":1
},
{
...
"url":6,
"doc":"Return the character that the fixation falls inside as an  InterestArea . For the interpretation of  line_n and  alphabetical_only , see  TextBlock.characters() .",
"func":1
},
{
