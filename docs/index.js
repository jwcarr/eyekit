...
{
"ref":"eyekit.analysis.go_past_time",
"url":2,
"doc":"Given an interest area or collection of interest areas, return the go-past time on each interest area. Go-past time is the sum duration of all fixations from when the interest area is first entered until when it is first exited to the right, including any regressions to the left that occur during that time period (and vice versa in the case of right-to-left text). Returns a dictionary in which the keys are interest area IDs and the values are gaze durations.",
"func":1
},
{
"ref":"eyekit.analysis.second_pass_duration",
"url":2,
"doc":"Given an interest area or collection of interest areas, return the second pass duration on each interest area. Second pass duration is the sum duration of all fixations inside an interest area during the second pass over that interest area. Returns a dictionary in which the keys are interest area IDs and the values are gaze durations.",
"func":1
},
{
...
{
"ref":"eyekit.analysis.number_of_regressions_in",
"url":2,
