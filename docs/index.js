...
"url":5,
"doc":"Iterate over each word as an  InterestArea . Optionally, you can supply a regex pattern to pick out only certain words. For example,  '[Tt]he' gives you all occurances of the word  the or  '[a-z]+ing' gives you all words ending  -ing .  add_padding adds a little extra width to each word's bounding box, so that they cover the adjoining spaces or punctuation.",
"func":1
},
{
