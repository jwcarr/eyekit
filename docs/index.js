...
"url":5,
"doc":"Representation of a piece of text, which may be a word, sentence, or entire multiline passage. Initialized with: -  text :  str (single line) or  list of  str (multiline) representing the text -  position :  tuple providing the XY-coordinates of the center of the first character in the text -  character_width :  int Pixel distance between characters -  line_height :  int Pixel distance between lines -  font :  str Font face (only affects how images are rendered and is not used in any internal calculations) -  fontsize :  int Fontsize (only affects how images are rendered and is not used in any internal calculations)"
},
{
...
{
"ref":"eyekit.text.TextBlock.character_width",
"url":5,
