...
"url":6,
"doc":"Combine image objects together into one larger image.  images should be a  list of  list of  Image structure representing the layout of the grid. For example,   img1, img2], [img3, img4  results in a 2x2 grid of images.  image_width is the desired mm (SVG, PDF, EPS) or pixel (PNG, JPEG, TIFF) width of the combined image. If  auto_letter is set to  True , each image will be given a letter label. Vertical, horizontal, and edge padding can be controlled with the relevant parameter.",
"func":1
}
]