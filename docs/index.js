...
"url":3,
"doc":"Create an image dipicting a PNG screenshot overlaid with a  eyekit.text.TextBlock in green. If no output path is provided, the output is written to the same directory as the screenshot file. This is useful for establishing the correct  eyekit.text.TextBlock parameters to match what participants are actually seeing.",
"func":1
},
{
...
"url":5,
"doc":" str Interest area ID. By default, these ID's have the form 1:5:10, which represents the line number and column indices of the  InterestArea in its parent  TextBlock . However, IDs can also be changed to any arbitrary string."
},
{
...
"url":5,
"doc":" tuple Position of the  TextBlock "
},
{
...
"ref":"eyekit.image",
"url":6,
"doc":"Defines the  Image and  Figure objects, which are used to create visualizations."
},
{
"ref":"eyekit.image.Image",
"url":6,
"doc":"The Image class is used to create visualizations of text blocks and fixation sequences, and it provides methods for drawing various kinds of annotation. The general usage pattern is:   img = eyekit.Image(1920, 1080) img.draw_text_block(txt) img.draw_fixation_sequence(seq) img.save('image.pdf')   Initialized with: -  screen_width  int : Width of the screen in pixels. -  screen_height  int : Height of the screen in pixels."
},
{
...
{
"ref":"eyekit.image.Image.set_background_color",
"url":6,
"doc":"Set the background color of the image. By default the background color is white.",
"func":1
},
{
"ref":"eyekit.image.Image.set_crop_margin",
"url":6,
"doc":"If you set a crop margin, the image will be cropped to the size of the  eyekit.text.TextBlock plus the specified margin. Margins are specified in millimeters if you intend to output to a vector format or pixels in the case of PNG. Note that, if you place the image inside a  Figure , this crop margin will be ignored; instead you should use  Figure.set_crop_margin() .",
"func":1
},
{
"ref":"eyekit.image.Image.draw_text_block",
"url":6,
"doc":"Draw a  eyekit.text.TextBlock on the image.  color sets the color of the text.",
"func":1
},
{
"ref":"eyekit.image.Image.draw_text_block_heatmap",
"url":6,
...
{
"ref":"eyekit.image.Image.draw_fixation_sequence",
"url":6,
...
{
"ref":"eyekit.image.Image.draw_sequence_comparison",
"url":6,
...
{
"ref":"eyekit.image.Image.draw_annotation",
"url":6,
...
"url":6,
"doc":"Save the image to some  output_path . Images can be saved as .pdf, .eps, .svg, or .png.  image_width only applies to the vector formats and determines the millimeter width of the output file; PNG images are saved at actual pixel size.",
"func":1
},
{
"ref":"eyekit.image.Figure",
"url":6,
"doc":"The Figure class is used to combine one or more images into a publication-ready figure. The general usage pattern is:   fig = eyekit.Figure(1, 2) fig.add_image(img1) fig.add_image(img2) fig.save('figure.pdf')   Initialized with: -  n_rows  int : Number of rows in the figure. -  n_cols  int : Number of columns in the figure."
},
{
...
"url":6,
"doc":"Set the vertical or horizontal padding between images or the padding around the edge of the figure. Padding is expressed in millimeters.",
"func":1
},
{
...
{
"ref":"eyekit.image.Figure.set_crop_margin",
"url":6,
"doc":"If you set a crop margin, each image in the figure will be cropped to the size and positioning of the most extreme text block extents, plus the specified margin. This has the effect of zooming in to all images in a consistent way \u2013 maintaining the aspect ratio and relative positioning of the text blocks across images. Margins are specified in figure millimeters.",
"func":1
},
{
"ref":"eyekit.image.Figure.add_image",
"url":6,
