...
"ref":"eyekit.io.read",
"url":4,
"doc":"Read in an Eyekit JSON file that has the following structure:   { \"trial_0\" : { \"participant_id\" : \"John\", \"passage_id\" : \"passage_a\", \"fixations\" :  412, 142, 131],  ., [588, 866, 224 }, \"trial_1\" : { \"participant_id\" : \"Mary\", \"passage_id\" : \"passage_b\", \"fixations\" :  368, 146, 191],  ., [725, 681, 930 } }   Lists of fixations are automatically converted into  fixation.FixationSequence objects.",
"func":1
},
{
"ref":"eyekit.io.write",
"url":4,
"doc":"Write out to an Eyekit JSON file.  fixation.FixationSequence objects are automatically serialized. Optionally, the  indent parameter specifies how much indentation to use in the files.",
"func":1
},
{
"ref":"eyekit.io.load_texts",
"url":4,
"doc":"Load texts from a JSON file that has the following structure:   { \"sentence_0\" : { \"first_character_position\" : [368, 155], \"character_spacing\" : 16, \"line_spacing\" : 64, \"font\" : \"Ubuntu Mono\", \"fontsize\" : 28, \"text\" : \"The quick brown fox jumped over the lazy dog.\" }, \"sentence_1\" : { \"first_character_position\" : [368, 155], \"character_spacing\" : 16, \"line_spacing\" : 64, \"font\" : \"Ubuntu Mono\", \"fontsize\" : 28, \"text\" : \"Lorem ipsum dolor sit amet, consectetur adipiscing elit.\" } }    text.TextBlock objects are created automatically, resulting in the dictionary:   { \"sentence_0\" : TextBlock[The quick brown  .], \"sentence_1\" : TextBlock[Lorem ipsum dolo .] }  ",
"func":1
},
{
"ref":"eyekit.io.save_texts",
"url":4,
"doc":"Save a dictionary of texts, such as:   { \"sentence_0\" : TextBlock[The quick brown  .], \"sentence_1\" : TextBlock[Lorem ipsum dolo .] }   into a JSON file, resulting in:   { \"sentence_0\" : { \"first_character_position\" : [368, 155], \"character_spacing\" : 16, \"line_spacing\" : 64, \"font\" : \"Ubuntu Mono\", \"fontsize\" : 28, \"text\" : \"The quick brown fox jumped over the lazy dog.\" }, \"sentence_1\" : { \"first_character_position\" : [368, 155], \"character_spacing\" : 16, \"line_spacing\" : 64, \"font\" : \"Ubuntu Mono\", \"fontsize\" : 28, \"text\" : \"Lorem ipsum dolor sit amet, consectetur adipiscing elit.\" } }   Optionally, the  indent parameter specifies how much indentation to use in the files.",
"func":1
},
{
...
"url":5,
"doc":"Representation of a piece of text, which may be a word, sentence, or entire multiline passage. Initialized with: -  text :  str (single line) or  list of  str (multiline) representing the text -  first_character_position :  tuple providing the XY-coordinates of the center of the first character in the text -  character_spacing :  int Pixel distance between characters -  line_spacing :  int Pixel distance between lines -  font :  str Font face (only affects how images are rendered and is not used in any internal calculations) -  fontsize :  int Fontsize (only affects how images are rendered and is not used in any internal calculations)"
},
{
...
{
"ref":"eyekit.text.TextBlock.font",
"url":5,
"doc":" str font face"
},
{
...
"url":5,
"doc":"Iterate over each word as an  InterestArea .",
"func":1
},
{
"ref":"eyekit.text.TextBlock.which_word",
"url":5,
"doc":"Returns the word  InterestArea that the fixation falls inside",
"func":1
},
{
...
"url":6,
"doc":"Render a  eyekit.text.TextBlock on the image. If specified, the arguments  font and  fontsize override the defaults set on the  eyekit.text.TextBlock .",
"func":1
},
{
