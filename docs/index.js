...
"url":3,
"doc":"Create an image dipicting a screenshot overlaid with a  eyekit.text.TextBlock in green. The output is saved to the same directory as the screenshot file. This is useful for establishing the correct  eyekit.text.TextBlock parameters to match what participants are actually seeing.",
"func":1
},
{
...
"url":5,
"doc":"By default, Eyekit considers the alphabet to be the standard 26 Latin characters in upper and lower case. If you are working with another language it may be useful to change this default, so that all new  TextBlock objects are automatically initialized with a particular alphabet. To do this, call  set_default_alphabet() at the top of your script. For German, for example, you might do this:   eyekit.set_default_alphabet('A-Za-z\u00df\u00c4\u00d6\u00dc\u00e4\u00f6\u00fc')   Eyekit also provides built-in alphabets for several European languages, so it's also possible to do this:   eyekit.set_default_alphabet(eyekit.ALPHABETS['Polish'])  ",
"func":1
},
{
"ref":"eyekit.text.Box",
...
"url":5,
"doc":" float The y position of the character baseline"
},
{
...
"url":5,
"doc":" float The y position of the text baseline"
},
{
"ref":"eyekit.text.InterestArea.text",
"url":5,
"doc":" str String represention of the interest area"
},
{
...
"url":5,
"doc":" float Line height in points"
},
{
"ref":"eyekit.text.TextBlock.adjust_bbox",
"url":5,
"doc":" float Line height in points"
},
{
...
{
"ref":"eyekit.image.Image.caption",
"url":6,
"doc":" str A caption that will be placed above the image if you create a figure using  make_figure() . Set the caption using  Image.set_caption() ."
},
{
...
{
"ref":"eyekit.image.Image.insert_raster_image",
"url":6,
"doc":"Insert a a raster image file. If outputting to SVG, the raster image is only referenced; for all other formats, the raster image is embedded.",
"func":1
},
{
...
{
"ref":"eyekit.image.Image.set_caption",
"url":6,
"doc":"Give the image a caption which will be shown if you place the image in a figure using  make_figure() .",
"func":1
},
{
"ref":"eyekit.image.Image.save",
"url":6,
"doc":"Save the image to some  output_path . Images can be saved as .svg, .pdf, or .eps (vector formats) or .png, .jpg, or .tif (raster formats).  image_width only applies to the vector formats where it determines the mm width; raster images are saved at actual pixel size.",
"func":1
},
{
"ref":"eyekit.image.make_figure",
"url":6,
"doc":"Combine image objects together into one larger image.  images should be a  list of  list of  Image structure representing the layout of the grid. For example,   img1, img2], [img3, img4  results in a 2x2 grid of images.  image_width is the desired mm (SVG, PDF, EPS) or pixel (PNG, JPEG, TIFF) width of the combined image. If  auto_letter is set to  True , each image caption will be prefixed with a letter. Vertical, horizontal, and edge padding can be controlled with the relevant parameter.",
"func":1
}
]